...
<body>
    <div class="login-container">
        ...
        <form action="check_username.php" method="POST" onsubmit="return validateForm()">
            <label for="inputData">Enter your Username:</label>
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4) {
                ...
                if (response === "false") {
                    ...
                    errorMessage.textContent = "Username Doesn't Exist"; // Display error message
